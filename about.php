...
<!-- about -->
<div class="about-inner bg-li-new py-5">
...
<!-- why -->
<section class="why bg-wh py-5" id="why">
					...
					<div class="ser-grd">
						<div class="row">
							...
							<div class="col-md-9 col-10 text-left services-grid">
								<h4>Integration</h4>
								<p>User integration is main aspect and we make user it works as intended.</p>
							</div>
						</div>
					</div>
				...
				<div class="col-md-4">
					...
					<div class="ser-grd mt-md-5 mt-4">
						<div class="row">
							...
							<div class="col-md-9 col-10 text-left services-grid">
								<h4>Monitoring</h4>
								<p>We also provide ways to monitor traffic on website on broad scale for business decisions.</p>
							</div>
						</div>
					</div>
				</div>
				<div class="col-md-4">
					<div class="ser-grd mt-md-0 mt-4">
						<div class="row">
							...
							<div class="col-md-9 col-10 text-left services-grid">
								<h4>Security</h4>
								<p>We provide secure envirement where data integrity and confidentiality is implimented</p>
							</div>
						</div>
					</div>
					<div class="ser-grd mt-md-5 mt-4">
	...
	<section class="team bg-li py-5" id="team">
		<div class="container py-xl-5 py-lg-3">
			...
			<p class="sub-tittle text-center mt-3 mb-sm-5 mb-4">We have team of experianced professionals to provide you with better results. </p>
			<div class="row ab-info second pt-lg-4">
				<div class="col-lg-4 col-sm-6 ab-content text-center mt-lg-0 mt-4">
					<div class="ab-content-inner">
						...
						<div class="ab-info-con">
							<h4 class="text-team-temps-amk">Satyendra Singh</h4>
				...
				<div class="col-lg-4 col-sm-6 ab-content text-center mt-lg-0 mt-4">
					<div class="ab-content-inner">
						<img src="images/t1.jpg" alt="news image" class="img-fluid">
						<div class="ab-info-con">
							<h4 class="text-team-temps-amk">Abhishek Mishra</h4>
							<ul class="list-unstyled team-socil-temps-amkpvts">
								<li class="d-inline">
									<a href="#"><span class="fab fa-facebook-f"></span></a>
								</li>
